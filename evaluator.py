...
def evaluate_pc(ip, subnet, def_gate, sw_def, sw_cidr):
...
def evaluate_switch(sw_def, sw_cidr):
    switch_value = subnet_values(sw_def, sw_cidr)
    error_list = []
...
result_values = evaluate_pc(ip_address, subnet_mask, def_gateway, switch_default_gateway, switch_cidr_notation)
print(result_values)
result_values = evaluate_switch(switch_default_gateway, switch_cidr_notation)
print(result_values)
